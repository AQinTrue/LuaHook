                        ...
                        try {
                            ...
                            if (compareVersions(latestVersion, currentVersion ?: "0.0.0") > 0) {
                                ...
                                AlertDialog.Builder(this@AboutActivity)
                                    ...
                                    .setMessage(resources.getString(R.string.current_version)+"$currentVersion"+resources.getString(
                                        R.string.n_latest_version)+"$latestVersion"+resources.getString(
                                        R.string.if_goto_github))
