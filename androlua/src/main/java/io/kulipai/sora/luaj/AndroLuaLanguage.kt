...
class AndroLuaLanguage(
    ...
    init {
        ...
        addBasePackage(
            "lpparam",
            package_lpparam.split('|')
        )
        addBasePackage(
            "suparam",
            package_suparam.split('|')
        )
        addBasePackage(
            "dexkitbridge",
            package_DexKitBridge.split('|')
        )
        addBasePackage(
            "dexfinder",
            package_DexFinder.split('|')
        )
        addBasePackage(
            "http",
            package_http.split('|')
